...
$(document).ready(function() {
  var url ='https://api.weatherstack.com/forecast?access_key=5bc82451636190abd9d7afe6fe9b20b5&query=40.01,-105.2705&forecast_days=6'; //Place your weatherstack API Call Here - access_key to be used: 5bc82451636190abd9d7afe6fe9b20b5
  ...
  $.ajax({url:url, dataType:"jsonp"}).then(function(data) {
    ...
    document.getElementById("image_today").src = img_today;
    ...
    */
    ...
    for(var i = 1; i<6;i++){
      ...
      console.log(data);
        forecastElementStr += '<div style = "width: 20%;"><div class = "card"><div class = "card-body"><h5 class = "card-title" >'+dayOfWeek+
    ...
    document.getElementById('5_day_forecast').innerHTML = forecastElementStr;
