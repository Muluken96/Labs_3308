...
function begin_play(){
	...
	var isEmptyp1 = isEmpty(player1.value);
	var isEmptyp2 = isEmpty(player2.value);
	console.log(isEmptyp1);
	console.log(isEmptyp2)

	if (isEmptyp1 && isEmptyp2){
		alert("don't start the game");
	}
...
function reset_play(){
	...
	document.getElementById("turn_info").innerHTML = "The game has not started";
...
function play(){
	var valid = document.getElementById("move_text_id").value
	if (this.started == true)
	{
		if (valid == "A1"|| valid == "A2" || valid == "A3" || valid == "B1" || valid || valid == "B2" || valid == "B3" || valid == "C1" || valid == "C2" || valid == "C3")
