...
app.get('/home/pick_color', function(req, res) {
	...
	var color_message = 'select * from color_msg from faborite_colors where hex_value=\''+color_choice+'\;'// Write a SQL query to retrieve the color message for the selected color
...
app.get('/team_stats', (req, res)=>{
	...
	.then(data => {
		var visitorScores = []
		data[0].forEach(gameDate=>{
			visitorScores.append(gameDate.visitor_score)
		});

		console.log(data[0][0].home_score)
		res.render('pages/team_states',{
			my_title: "Home page",
			visitor_score: visitorScores
